...
--
-- Host: localhost
-- Generation Time: Oct 11, 2024 at 01:40 PM
...
--
ALTER TABLE `room_courses`
  MODIFY `room_course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
ALTER TABLE `room_courses`
  ...
  ADD CONSTRAINT `room_courses_ibfk_3` FOREIGN KEY (`schedule_id`) REFERENCES `room_schedules` (`schedule_id`);
