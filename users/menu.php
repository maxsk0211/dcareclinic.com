        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <div class="menu-inner-shadow"></div>
            <ul class="menu-inner py-1">
                <li class="menu-item  <?= ($_SERVER['PHP_SELF']=='/users/index.php')? 'active' : ''?>">
                    <a href="index.php" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Dashboard">Dashboard</div>
                    </a>
                </li>
                <li class="menu-item <?= ($_SERVER['PHP_SELF']=='/users/user-profile.php')? 'active' : ''?>">
                    <a href="user-profile.php" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-user"></i>
                        <div data-i18n="Profile">Profile</div>
                    </a>
                </li>
                <li class="menu-item <?= ($_SERVER['PHP_SELF']=='/users/user-appointments.php')? 'active' : ''?>">
                    <a href="user-appointments.php" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-calendar"></i>
                        <div data-i18n="Appointments">Appointments</div>
                    </a>
                </li>
                <li class="menu-item <?= ($_SERVER['PHP_SELF']=='/users/user-courses.php')? 'active' : ''?>">
