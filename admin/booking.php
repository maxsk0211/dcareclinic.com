...
// ดึงข้อมูลคอร์ส
$sql_courses = "SELECT course_id, course_name, course_price, course_pic FROM course WHERE course_status = 1";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['booking']) && $_POST['booking'] == 1) {
        ...
        $sql_insert = "INSERT INTO course_bookings (branch_id,course_id, cus_id, booking_datetime, users_id, status) 
                        VALUES ('$branch_id','$course_id', '$selected_customer_id', '$booking_datetime', $users_id, 'confirmed')";
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="alert alert-solid-secondary"><h4 class="text-center text-white mt-3">รายการสั่งซื้อ</h4></div>
                                </div>
                                <div class="col-md-8">
                                                ...
                                                <div class="card course-item">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form method="POST" action="">
                                                            ...
                                                            <input type="hidden" name="customer_select" value="<?= $selected_customer_id; ?>">
                                                            <button type="submit" class="btn btn-primary">เลือกคอร์สนี้</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
