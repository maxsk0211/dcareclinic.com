...
<html
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                  <h5 class="card-title mb-0 alert alert-danger">ข้อมูลเครื่องมือแพทย์ในระบบทั้งหมด</h5>
                  <div>
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addToolModal">เพิ่มเครื่องมือ</button>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel3">เพิ่มเครื่องมือใหม่</h5>
                        ...
                        <form action="sql/tool-insert.php" method="post">
                          ...
                          <div class="row">
                            <div class="col mb-3">
                              ...
                              <textarea id="tool_detail" name="tool_detail" class="form-control"></textarea>
                            </div>
                          </div>
                          <div class="row g-2">
                            <div class="col mb-3">
  ...
  <!--                           <div class="col mb-3">
                              <label for="tool_amount" class="form-label">จำนวน</label>
                              <input type="number" id="tool_amount" name="tool_amount" class="form-control" required />
                            </div> -->
                            <div class="col mb-3">
                              <label for="tool_unit_id" class="form-label">หน่วยนับ</label>
                              <select id="tool_unit_id" name="tool_unit_id" class="form-select" required>
                          ...
                          <div class="row">
                            ...
                            <div class="col mb-3">
                              ...
                              <select id="tool_status" name="tool_status" class="form-select" required>
                ...
                <div class="container">
                  <div class="card-datatable table-responsive">
                    <table id="toolTable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
